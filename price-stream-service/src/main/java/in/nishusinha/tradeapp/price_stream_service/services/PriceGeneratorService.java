...
@ConditionalOnProperty(prefix = "tradeapp.prices.generation", name = "enabled", havingValue = "true", matchIfMissing = true)
...
public class PriceGeneratorService {
    ...
    @Scheduled(fixedDelayString = "${tradeapp.prices.generation-interval-ms:2000}")
