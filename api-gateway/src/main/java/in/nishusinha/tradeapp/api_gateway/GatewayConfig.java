...
public class GatewayConfig {
    ...
    @Bean
    RouteLocator tradeappRoutes(RouteLocatorBuilder builder,
                              @Value("${tradeapp.services.auth:lb://auth-service}") String authServiceUrl,
                              @Value("${tradeapp.services.market:lb://market-service}") String marketServiceUrl,
                              @Value("${tradeapp.services.portfolio:lb://portfolio-service}") String portfolioServiceUrl,
                              @Value("${tradeapp.services.price-stream:lb://price-stream-service}") String priceStreamServiceUrl,
                              @Value("${tradeapp.services.price-stream-ws:lb:ws://price-stream-service}") String priceStreamWebSocketUrl,
                              @Value("${tradeapp.services.notification:lb://notification-service}") String notificationServiceUrl) {
