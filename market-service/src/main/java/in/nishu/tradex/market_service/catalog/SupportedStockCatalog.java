package in.nishu.tradex.market_service.catalog;
...
public class SupportedStockCatalog {
   private final List<StockSeed> stocks=List.of(
           ...
           stock("TCS","Tata Coonsultancy Services Limited","NSE","Technology","3890.70"),
           ...
           stock("LT","Larsen & Turbo Limited","NSE","Infrastructure","3615.60"),
           ...
           stock("NIFTYBEES","Nippon India ETF Nifty 500 BeEs","NSE","ETF","275.50"),
   ...
   public List<String> symbols(){
       return stocks.stream().map(StockSeed::symbol).toList();
   }
   ...
   public record StockSeed(String symbol,String name,String exchange,String sector,BigDecimal refrencePrice){
       public Stock toEntity(){
           return new Stock(symbol,exchange,name,sector,refrencePrice,false);
       }
   }
}
