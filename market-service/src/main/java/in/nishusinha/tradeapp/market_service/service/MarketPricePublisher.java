package in.nishusinha.tradeapp.market_service.service;

import in.nishusinha.tradeapp.common_lib.stock.Helper;
import in.nishusinha.tradeapp.market_service.dtos.MarketDtos;
import in.nishusinha.tradeapp.market_service.dtos.PriceTick;
...
public class MarketPricePublisher {
    ...
    public MarketPricePublisher(KafkaTemplate<String, PriceTick> kafkaTemplate,
                                @Value("${tradeapp.market.topic:tradeapp.market.prices}") String topic) {
