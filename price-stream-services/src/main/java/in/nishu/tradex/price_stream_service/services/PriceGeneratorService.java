...
import in.nishu.tradex.price_stream_service.data_seeding.SeedPriceCatalog;
...
public class PriceGeneratorService {
    ...
    public void syntheticBatchGenerator(){
        for (String confgiredSymbol: properties.getSymbols()){
            String symbol=confgiredSymbol.trim().toUpperCase();
