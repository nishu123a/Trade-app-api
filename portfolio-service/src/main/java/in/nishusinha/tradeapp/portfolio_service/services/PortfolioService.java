package in.nishusinha.tradeapp.portfolio_service.services;

import in.nishusinha.tradeapp.common_lib.security.JwtPrincipal;
import in.nishusinha.tradeapp.portfolio_service.clients.MarketClient;
import in.nishusinha.tradeapp.portfolio_service.dtos.MarketDtos;
import in.nishusinha.tradeapp.portfolio_service.dtos.OrderDtos;
import in.nishusinha.tradeapp.portfolio_service.dtos.PortfolioDtos;
import in.nishusinha.tradeapp.portfolio_service.dtos.StockResponse;
import in.nishusinha.tradeapp.portfolio_service.dtos.TransactionResponse;
...
import in.nishusinha.tradeapp.portfolio_service.enums.OrderSide;
import in.nishusinha.tradeapp.portfolio_service.repositories.HoldingRepository;
import in.nishusinha.tradeapp.portfolio_service.repositories.LedgerTransactionRepository;
import in.nishusinha.tradeapp.portfolio_service.repositories.PortfolioAccountRepository;
import in.nishusinha.tradeapp.portfolio_service.repositories.TradeOrderRepository;
...
public class PortfolioService {
    ...
    public PortfolioService(HoldingRepository holdingRepository,
                            ...
                            @Value("${tradeapp.trading.starting-cash:1000000.00}") BigDecimal startingCash) {
